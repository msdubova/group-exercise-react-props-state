...
interface ChuckData {
	whalesSavedByChuck: number;
	roundHouseKicksByChuck: number;
  }

const ChuckInfo: React.FC<ChuckData> = ({whalesSavedByChuck, roundHouseKicksByChuck}) => {
	...
	return (
		<>
			<p>Number of Whales Saved: {whalesSavedByChuck}</p>

			<p>Number of Round House Kicks (in the last day): {roundHouseKicksByChuck}</p>
		</>);
}
